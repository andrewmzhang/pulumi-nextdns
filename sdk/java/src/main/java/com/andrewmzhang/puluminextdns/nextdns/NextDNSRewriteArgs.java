...
public final class NextDNSRewriteArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Profile Id to apply rewrite to.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param profileId Profile Id to apply rewrite to.
         * 
         * @return builder
         * 
         */
        ...
        public NextDNSRewriteArgs build() {
            ...
            if ($.profileId == null) {
                throw new MissingRequiredPropertyException("NextDNSRewriteArgs", "profileId");
            }
            return $;
        }
    }
