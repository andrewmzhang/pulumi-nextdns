...
import com.andrewmzhang.puluminextdns.ProviderArgs;
...
@ResourceType(type="pulumi:providers:pulumi-nextdns")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumi-nextdns", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
