...
namespace Andrewmzhang.PulumiNextdns
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Andrewmzhang.PulumiNextdns.version.txt");
    ...
    internal sealed class PulumiNextdnsResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PulumiNextdnsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
