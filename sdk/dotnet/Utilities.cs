...
namespace Andrewmzhang.Nextdns
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Andrewmzhang.Nextdns.version.txt");
    ...
    internal sealed class NextdnsResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NextdnsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
