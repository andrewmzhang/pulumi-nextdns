...
import (
	...
	"errors"
	"github.com/andrewmzhang/pulumi-nextdns/sdk/go/pulumi-nextdns/internal"
...
type NextDNSRewrite struct {
	...
	RewriteId pulumi.StringOutput `pulumi:"rewriteId"`
}
...
// ProfileId of the profile this rewrite belongs to.
func (o NextDNSRewriteOutput) ProfileId() pulumi.StringOutput {
	return o.ApplyT(func(v *NextDNSRewrite) pulumi.StringOutput { return v.ProfileId }).(pulumi.StringOutput)
}

// RewriteID as represented in NextDNS
func (o NextDNSRewriteOutput) RewriteId() pulumi.StringOutput {
	return o.ApplyT(func(v *NextDNSRewrite) pulumi.StringOutput { return v.RewriteId }).(pulumi.StringOutput)
}
