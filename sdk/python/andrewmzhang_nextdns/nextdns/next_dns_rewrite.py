...
class NextDNSRewriteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] content: IP Address or Domain to rewrite domain name to.
        :param pulumi.Input[_builtins.str] name: Domain name to apply rewrite to.
        :param pulumi.Input[_builtins.str] profile_id: Profile Id to apply rewrite to.
        """
...
class NextDNSRewrite(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="rewriteId")
    def rewrite_id(self) -> pulumi.Output[_builtins.str]:
        """
        RewriteID as represented in NextDNS
        """
        return pulumi.get(self, "rewrite_id")
